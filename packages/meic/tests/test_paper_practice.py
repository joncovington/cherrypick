...
def _ic():
    return {
        "legs": {
            "sp": "SPXW  260709P07450000",
            "lp": "SPXW  260709P07445000",
            "sc": "SPXW  260709C07540000",
            "lc": "SPXW  260709C07545000",
            "sp_k": 7450.0,
            "sc_k": 7540.0,
        },
        "net_credit": 1.40,
...
def _all_marks():
    return {
        "SPXW  260709P07450000": 0.90,
        "SPXW  260709P07445000": 0.40,
        "SPXW  260709C07540000": 1.60,
        "SPXW  260709C07545000": 0.30,
    }


def test_mark_map_from_positions():
    positions = [
        {"instrument": "SPXW  260709P07450000", "price": "0.90", "quantity": "1"},
...
def test_mark_map_excludes_zero_quantity_closed_legs():
    ...
    positions = [
        {"instrument": "SPXW  260709P07450000", "price": "0.90", "quantity": "1", "direction": "short"},
...
def test_finalize_ic_stopped_put_plus_expired_call():
    ...
    ic = _finalizable_ic(
        exit={"call": None, "put": 1.50},
        exit_fee={"call": 0.0, "put": 0.72},
