            ...
            data=json.dumps(
                {
                    ...
                    "entry_time": "2026-07-16 12:05:00",
                    "symbol": "XSP",
                    "put_strike": 545,
                    "call_strike": 560,
                    "wing_width": 5,
                    "net_credit": 0.95,
                    "quantity": 1,
                    "call_delta_at_entry": 0.14,
                    "put_delta_at_entry": -0.15,
                    "long_call_delta_at_entry": 0.07,
                    "long_put_delta_at_entry": -0.08,
                    "underlying_price_entry": 552.3,
                    "iv_rank_at_entry": 0.34,
            ...
            data=json.dumps(
                {
                    "ic_order_id": "A2",
                    "trade_date": "2026-07-16",
                    "entry_time": "2026-07-16 12:40:00",
                    "symbol": "QQQ",
                    "put_strike": 470,
                    "call_strike": 486,
                    "wing_width": 4,
                    "net_credit": 0.80,
                    "quantity": 1,
                    "call_delta_at_entry": 0.16,
                    "put_delta_at_entry": -0.13,
                    "long_call_delta_at_entry": 0.09,
                    "long_put_delta_at_entry": -0.07,
                    "underlying_price_entry": 478.1,
                    "iv_rank_at_entry": 0.31,
...
def test_analysis_surfaces_loop_gates_from_loop_log(tmp_path, monkeypatch, capsys):
    ...
    reasoning = (
        "[11:34 ET] VIX 17.9  1D-ratio 0.65  delta 0.16   "
