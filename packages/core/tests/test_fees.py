...
def test_entry_costs_open_commission_pass_through_slippage():
    ...
    # slippage: (0.10+0.06)*0.125*100*3 = 6.00 (cap 0.15*mid not binding on these liquid legs)
...
def test_exit_costs_are_open_only_zero_commission():
    ...
    assert out == {"commission": 0.00, "pass_through_fees": 0.84, "slippage": 6.00, "total_cost": 6.84}
