"""Cost-adjusted paper fills — thin shim over cherrypit.fees (src/_core submodule).
...
cherrypit.fees for the implementation, source, and rationale.
"""
...
from cherrypit.fees import (  # noqa: E402
    DEFAULT_COSTS,
    apply_entry_costs,
    apply_exit_costs,
)
