...
Verbs:
    build    Build and write one session's morning fact pack (and its render). Also refreshes the
             stream request registration, best-effort, so the breadth symbols stay declared.
