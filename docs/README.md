...
| [reporting-and-dashboard.md](reporting-and-dashboard.md) | The read side: unified P&L report, calibration, the deterministic EOD reports (paper-eod + 7-section analysis), the AI EOD insight, the suite digest, the console, and end-of-month log/report archiving. |
