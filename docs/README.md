...
- **Flies** — [`packages/flies/README.md`](../packages/flies/README.md) (start here), [`packages/flies/CLAUDE.md`](../packages/flies/CLAUDE.md) (strategy, honesty rules, the width-arm experiment), [`packages/flies/docs/live-trading-plan.md`](../packages/flies/docs/live-trading-plan.md) (the gated live plan), and [`packages/flies/docs/faq.md`](../packages/flies/docs/faq.md) (recurring questions: what the strategy is, why SPX/XSP and not SPY or /ES-/MES futures options).
- **Streamer** — [`packages/streamer/README.md`](../packages/streamer/README.md) (start here: what it produces, the subscription registry, and why it is supervised harder than anything else), [`packages/streamer/CLAUDE.md`](../packages/streamer/CLAUDE.md), and [streamer-package-plan.md](streamer-package-plan.md) (why it was split out of MEIC).
- **Console** — [`packages/console/README.md`](../packages/console/README.md), [`packages/console/CLAUDE.md`](../packages/console/CLAUDE.md), and [`packages/console/docs/`](../packages/console/docs/): [parity](../packages/console/docs/parity.md) (what it does and doesn't yet cover versus the per-module dashboards), [verify-notes](../packages/console/docs/verify-notes.md). The suite's one TypeScript package; it has no architecture doc yet — a known gap, deliberately deferred while the package is still moving fast.
- **Scout** — [`packages/scout/README.md`](../packages/scout/README.md) (the substantial one — start here), [`packages/scout/CLAUDE.md`](../packages/scout/CLAUDE.md), and [strategy-screening-parameters](../packages/scout/docs/strategy-screening-parameters.md).
- **Desk** — [`packages/desk/README.md`](../packages/desk/README.md) and [`packages/desk/CLAUDE.md`](../packages/desk/CLAUDE.md). The manual trading desk: read these before using it, because it is the one surface that places live orders on your instruction.
