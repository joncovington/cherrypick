...
- **Orchestrator** — [`packages/orchestrator/CLAUDE.md`](../packages/orchestrator/CLAUDE.md) (build/architecture/invariants); shipped history is git log / commit history (`ROADMAP.md` is deprecated — frozen Stage 0 record only, see its own header).
